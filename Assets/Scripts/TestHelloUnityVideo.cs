...
namespace Demo
{
    public class TestHelloUnityVideo
    {
        ...
        public void onSceneHelloVideoLoaded()
        {
            ...
            //Debug.Log("Attach to Screen");
            //GameObject screenDisplay = GameObject.Find("Screen");
            //if (ReferenceEquals(screenDisplay, null))
            //{
            //    Debug.Log("BBBB: failed to find ScreenDisplay");
            //}
            //else
            //{
            //    screenDisplay.AddComponent<VideoSurface>();
            //}
        }
        ...
        public VideoSurface makeImageSurface_orig(string goName)
        {
